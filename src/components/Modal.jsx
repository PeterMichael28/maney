...
const Modal = ( {
 ...
 if (!isOpen) {
  ...
  return (
    <>
    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto text-black fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
     <div className="relative w-full md:w-3/6 lg:w-2/6 xl:w-2/5 my-6 mx-auto h-ful md:h-auto">
      {/* content */}
      <div
